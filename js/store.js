(() => {
  ...
  async function signIn(email, password) {
    ...
    if (!client) throw new Error('Banco Supabase não configurado. Use o modo demonstração ou configure o banco.');
  ...
  const tableMap = { schools: 'escolas', transport: 'agendamentos_transporte', visits: 'visitas', management: 'acompanhamentos_gestao' };
  ...
  window.PortalStore = {
    getConfig, setConfig, clearConfig, getSupabase, isOnlineMode,
    signIn, signOut, currentSession, setDemoSession, clearDemoSession,
